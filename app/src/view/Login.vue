                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input id="email-address" name="email" type="email" autocomplete="email" required
                                    v-model="user.email"
                                    class="input-form appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo focus:border-indigo sm:text-sm mb-2" />
                            </div>
                        </div>
                        <div>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-sm">
                            <router-link :to="{ name: 'Forgot' }"
                                class="font-medium text-indigo-600 hover:opacity-80">Esqueceu sua senha?
                            </router-link>
                        </div>
                    </div>
    ...
    store.dispatch('login', user)
        ...
        .catch(err => {
            try {
                ...
                errMsg.value = "Erro ao acessar o banco de dados!"
            }
        })
}
</script>
